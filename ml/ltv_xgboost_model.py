"""
LTV prediction model using XGBoost.
...
def train_xgboost_model(X, y, tune_hyperparameters=True, n_trials=50):
    ...
    # Stratified train-test split by payers/non-payers
...
def evaluate_model(model, X_train, X_test, y_train, y_test):
    ...
    # Check if model is XGBRegressor or native XGBoost
...
def main():
    ...
    model, X_train, X_test, y_train, y_test, study = train_xgboost_model(
        X, y, tune_hyperparameters=True, n_trials=50
    )
