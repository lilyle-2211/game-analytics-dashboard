    ...
    with st.container():
        ...
        with col_manual:
            ...
            render_manual_insights(
                DAILY_USER_METRICS, height=300, key_suffix="engagement"
            )
...
def _render_daily_return_rate_analysis(explainer):
    ...
    with st.container():
        ...
        with col_manual:
            st.markdown("**Key Notes**")
            render_manual_insights(
                DAILY_LEVEL_METRICS, height=400, key_suffix="return_rate"
            )

        # SQL Query & Data Sample section spanning across all columns
...
def _render_two_week_retention_analysis(explainer):
    ...
    with st.container():
        ...
        with col_manual:
            st.markdown("**Key Notes**")
            render_manual_insights(
                TWO_WEEK_RETENTION_INSIGHTS, height=200, key_suffix="two_week_retention"
            )
